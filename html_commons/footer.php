...
<footer>
    <div class="footer-container">
        <div class="miranda-info">
            <div class="miranda-info--logo">
                <img src="./assets/images/H_logo_footer.PNG" alt="Logo_miranda" />
                <img src="./assets/images/hotel_miranda_text.png" alt="logo-miranda" />
            </div>
    ...
    <div class="miranda-contact">
        ...
        <div class="miranda-contact--mail">
            <img src="./assets/images/contact-mail.png" alt="mail-icon" />
            <div class="miranda-contact--info">
                <p class="footer-subtitle">Phone Number</p>
                <p class="footer-content">+987 87 67 78</p>
            </div>
        ...
        <div class="miranda-contact--location">
            <img src="./assets/images/contact-position.png" alt="location-icon" />
            <div class="miranda-contact--info">
                <p class="footer-subtitle">Phone Number</p>
                <p class="footer-content">+987 87 67 78</p>
            </div>
